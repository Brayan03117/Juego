...
def Pos6(t_x, t_y, t_z):
    ...
    # Brazos en posición de sorpresa (ambos hacia arriba)
    draw_cylinder2(1.28 + t_x, 2.75 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(90, 0, 90))  # Brazo izquierdo
    draw_cylinder2(1.28 + t_x, 5.25 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(90, 0, 0))  # Brazo derecho
...
def Pos7(t_x, t_y, t_z):
    ...
    # Piernas (más delgadas y color azul) - una pierna levantada
    draw_cylinder(1.25 + t_x, 3.25 + t_y, 0.5 + t_z, 2, 0.2, 32, (0/255, 0/255, 255/255))  # Azul
    draw_cylinder2(1.25 + t_x, 4.75 + t_y, 0.5 + t_z, 2, 0.2, 32, (0/255, 0/255, 255/255), rotation=(45, 0, 0))  # Azul - pierna levantada
    
    # Pies
    draw_rectangular_prism(1, 0.5, 0.5, (1,1,1), (1 + t_x, 3 + t_y, 0 + t_z))  # Pie izquierdo
    # Pie derecho (rotado con la pierna)
    glPushMatrix()
    glTranslatef(1 + t_x, 4.5 + t_y, 0 + t_z)
    glRotatef(45, 1, 0, 0)  # Rotación para seguir la pierna
    draw_rectangular_prism(1, 0.5, 0.5, (1,1,1), (0, 0, 0))  # Posición relativa
    glPopMatrix()
    ...
    # Brazos en posición de celebración
    draw_cylinder2(1.28 + t_x, 2.75 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(60, 0, 0))  # Brazo izquierdo
    draw_cylinder2(1.28 + t_x, 5.25 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(-30, 0, 0))  # Brazo derecho
...
def Pos8(t_x, t_y, t_z):
    ...
    # Brazos caídos (tristeza)
    draw_cylinder2(1.28 + t_x, 2.75 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(-30, 0, 0))  # Brazo izquierdo
    draw_cylinder2(1.28 + t_x, 5.25 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(-30, 0, 0))  # Brazo derecho
...
def Pos9(t_x, t_y, t_z):
    ...
    # Piernas (más delgadas y color azul) - posición de caída
    draw_cylinder2(1.25 + t_x, 3.25 + t_y, 0.5 + t_z, 2, 0.2, 32, (0/255, 0/255, 255/255), rotation=(30, 0, 0))  # Azul
    draw_cylinder2(1.25 + t_x, 4.75 + t_y, 0.5 + t_z, 2, 0.2, 32, (0/255, 0/255, 255/255), rotation=(-30, 0, 0))  # Azul
    
    # Pies (rotados con las piernas)
    glPushMatrix()
    glTranslatef(1 + t_x, 3 + t_y, 0 + t_z)
    glRotatef(30, 1, 0, 0)  # Rotación para seguir la pierna
    draw_rectangular_prism(1, 0.5, 0.5, (1,1,1), (0, 0, 0))  # Posición relativa
    glPopMatrix()
    ...
    # Brazos extendidos (como desmayado)
    draw_cylinder2(1.28 + t_x, 2.75 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(90, 0, 0))  # Brazo izquierdo
    draw_cylinder2(1.28 + t_x, 5.25 + t_y, 5 + t_z, height=1.75, radius=0.2, slices=32, color=(255/255, 0/255, 0/255), rotation=(180, 0, 0))  # Brazo derecho
